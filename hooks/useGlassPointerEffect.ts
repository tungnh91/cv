...
const GLASS_BUTTON_SELECTOR = '.glass-button, .glass-icon-button';

export default function useGlassPointerEffect() {
  useEffect(() => {
    ...
    const syncBubblePosition = () => {
      ...
      const hoveredButton = hoveredElement?.closest(GLASS_BUTTON_SELECTOR);
